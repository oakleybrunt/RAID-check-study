...
plt.title("Effect Size of Lockahead on Net Write Rate during RAID")
...
plt.ylabel("Observed Effect Size")
plt.xlabel("XIOS Nodes")
plt.title("Effect Size of RAID on Net Write Rate")
...
plt.ylabel("Observed Effect Size")
plt.xlabel("XIOS Nodes")
plt.title("Effect Size of Lockahead on Net Write Rate")
